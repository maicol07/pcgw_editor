...
const emit = defineEmits<{
    (e: 'update:modelValue', value: ReleaseDate[]): void;
}>();

// Use the extracted logic
const { structuredDates, addReleaseDate, removeReleaseDate } = useInfoboxDates(props.modelValue, (newDates) => {
          ...
          <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex-1 relative">
                ...
                <div class="absolute right-1 top-1/2 -translate-y-1/2">
                    <Button severity="secondary" text rounded size="small" class="relative overflow-hidden w-8 h-8 !p-0 flex items-center justify-center">
            ...
            <Button severity="danger" variant="outlined" @click="removeReleaseDate(index)" size="small" class="!w-8 !h-8 !p-0">
