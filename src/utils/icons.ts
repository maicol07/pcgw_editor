...
import iconStoreDiscord from '../assets/icons/social-discord.svg';
...
export const iconMap = {
    ...
    store: {
        ...
        'epic games store subpage': iconStoreEpicgames,
        'gamersgate': iconStoreGamersgate,
        'gfwl': iconStoreGfwl,
        'gfw marketplace': iconStoreGfwl,
        'gfwl marketplace': iconStoreGfwl,
        'games for windows marketplace': iconStoreGfwl,
        'gog': iconStoreGogcom,
